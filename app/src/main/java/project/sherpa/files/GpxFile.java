...
public class GpxFile extends BaseFile {
    ...
    public GpxFile(String firebaseId, String parent, String child) {
        super(parent, child);
        this.firebaseId = firebaseId;
    }

    public GpxFile(String firebaseId, File parent, String child) {
        super(parent, child);
        this.firebaseId = firebaseId;
    }

    public GpxFile(String firebaseId, File parent) {
        super(parent, firebaseId + GPX_EXT);
        this.firebaseId = firebaseId;
    }

    public GpxFile(String firebaseId, @NonNull URI uri) {
