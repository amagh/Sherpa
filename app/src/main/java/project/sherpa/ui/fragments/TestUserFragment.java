...
public class TestUserFragment extends ConnectivityFragment implements FabSpeedDial.MenuListener {
     ...
     */
    public static TestUserFragment newInstance(String userId) {
